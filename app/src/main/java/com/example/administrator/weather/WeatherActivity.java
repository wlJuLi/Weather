...
public class WeatherActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        degreeTitle = (TextView) findViewById(R.id.degree_text);
        weatherInfoTitle = (TextView) findViewById(R.id.weather_info_text);
        forecastLayout = (LinearLayout) findViewById(R.id.forecast_layout);
        aqiText = (TextView) findViewById(R.id.aqi_text);
        pm25Text = (TextView) findViewById(R.id.pm25_text);
        carwashText = (TextView) findViewById(R.id.car_wash_text);
        comportText = (TextView) findViewById(R.id.comfort_text);
        ...
        swipeRefresh.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                ...
                String temp=preferences.getString("weather_id",mWeatherId);
                requestWeather(temp);
            }
        });
    ...
    private void showWeatherInfo(Weather weather) {
        ...
        weatherInfoTitle.setText(weatherInfo);
